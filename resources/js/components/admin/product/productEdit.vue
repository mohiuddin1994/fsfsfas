    ...
    <div>
        <div class="content-wrapper">
            ...
            <div class="card card-primary m-auto ">
                ...
                <form role="form" @submit.prevent="productUpdate" enctype="multipart/form-data">
                    <div class="card-body ">
                        <div class="col-lg-6">
...
<script>
    ...
    export default {
        ...
        mounted() {
         ...
         axios.get(`/productEdit/${this.$route.params.id}`).then((res)=>{
                ...
                if(data.attribute>0){
                    this.form.items = data.attribute
        ...
        methods: {
            ...
            productUpdate() {
                ...
                axios.post("/productUpdate/"+this.$route.params.id, data).then((res) => {
