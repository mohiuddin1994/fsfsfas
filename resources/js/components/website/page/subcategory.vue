							...
							<div class="row">
								<div class="tab-content grid-content">
									<div class="tab-pane fade in active text-center" id="grid">
										<div class="col-xs-12 col-sm-6 col-md-4" v-for="product,index in subcategoryProducts" :key="index">
									...
									<div class="tab-pane fade in" id="list">
										<div class="col-xs-12">
											<div class="single-list-view" v-for="product,index in subcategoryProducts" :key="index">
												<div class="row">
...
import axios from 'axios'
    ...
    export default {
        ...
        computed:{
            ...
            subcategoryProducts(){
              return this.$store.getters.subcategoryProduct
             }
        ...
        methods:{
            subcategoryProduct(){
                  this.$store.dispatch("subcategoryProduct",this.$route.params.id)
            },
				addToCart(product){
